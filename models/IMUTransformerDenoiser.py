...
class IMUTransformerDenoiser(nn.Module):
    ...
    def forward(self, data):
            ...
            src = self.input_proj(orig_src.transpose(1,2)).permute(2, 0, 1)
            ...
            # Estimate the noise residuals
            minus_noise = self.imu_head(target).transpose(1, 2)
            # remove the noise
